...
public class Adapter_Product_Update extends RecyclerView.Adapter<Adapter_Product_Update.ViewHolder>{
    ...
    holder.txtName.setText(ProductUpdatesArrayList.get(position).getName());
    holder.txtPrice.setText(String.valueOf(ProductUpdatesArrayList.get(position).getPrice()));
